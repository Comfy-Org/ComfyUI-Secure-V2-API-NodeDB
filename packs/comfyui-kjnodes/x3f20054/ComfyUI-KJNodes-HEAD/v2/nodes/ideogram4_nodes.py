...
- brightness slider, token estimate, and Copy / Paste / Clear all""",
    ...
    @classmethod
    async def execute(cls, width, height, background, style,
        ...
        image = None if image is None else await image.raw()
        ...
        return io.NodeOutput(dump(caption), await sdk.ImageRef._from_raw(preview), bboxes_out, width, height, ui=ui)


NODE_CLASS_MAPPINGS = {
    "Ideogram4PromptBuilderKJ": Ideogram4PromptBuilderKJ,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "Ideogram4PromptBuilderKJ": "Ideogram 4 Prompt Builder KJ",
}
