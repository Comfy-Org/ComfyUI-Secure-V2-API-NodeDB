...
def parse_prompt_attention(text, prompt_attention=None):
    """
    ...
    prompt_attention = prompt_attention or opts.prompt_attention
    if prompt_attention == 'Fixed attention':
        res = [[text, 1.0]]
        return res
    elif prompt_attention == 'Compel parser':
        ...
        return res
    elif prompt_attention == 'A1111 parser':
    ...
    for m in re_attention.finditer(text):
        ...
        if text.startswith('\\'):
            ...
            for i, part in enumerate(parts):
                if i > 0:
                    res.append(["BREAK", -1])
                if prompt_attention == 'Full parser':
