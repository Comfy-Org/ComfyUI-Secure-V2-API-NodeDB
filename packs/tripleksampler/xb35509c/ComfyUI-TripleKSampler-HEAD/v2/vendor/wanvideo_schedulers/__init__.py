# Vendored from ComfyUI-WanVideoWrapper; see UPSTREAM.md.  The sole source
# modification is replacing the parent pack's logger import with stdlib
# logging so this scheduler package remains self-contained in the guest.
import logging
...
log = logging.getLogger("triple_ksampler.vendor.wanvideo_schedulers")
