...
> Secure Nodes V2 release pinned to
> `fb38cf3294842d10fe7f0e933595dcd49b008d2b`. `LoraInfo` resolves only a
> managed LoRA catalogue entry and uses the fixed bounded CivitAI integration.
> The arbitrary-URL image node and editor-selection network side effect are
> security-rejected. See `SECURE_CONVERSION.md` for the complete census.
